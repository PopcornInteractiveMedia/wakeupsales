...
#*****************************************************************************************/
  ...
  before_filter :authenticate_admin, :except => [:update_profile_image,:save_tmp_img, :get_user_email, :profile,:save_profile_info, :update, :save_password,:load_header_count_user]
